...
const Hero = () => {
  return (
    <div
      className="flex flex-col md:flex-row justify-between items-center min-h-[60vh] md:min-h-[80vh] gap-8 md:gap-12 mx-auto px-4 sm:px-8 md:px-12 lg:px-[100px] pt-8 md:pt-12"
      style={{
    ...
    >
      <div className="w-full md:w-1/2 flex flex-col gap-5 md:gap-6 text-center md:text-left items-center md:items-start">
        ...
        <div className="flex items-center gap-3 md:gap-4 flex-wrap justify-center md:justify-start">
          ...
          <Button
            size="lg"
            className="cursor-pointer rounded-md px-4 w-fit bg-transparent border border-black text-black"
          >
            Request Demo
          </Button>
        </div>
