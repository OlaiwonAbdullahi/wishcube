    ...
    <div>
      ...
      <div className="">
        <div className="flex justify-between items-center w-10/12 mx-auto mb-8">
          ...
          <div className="flex-1 h-1 bg-gray-300 mx-2 mb-5"></div>
        ...
        <div className="">
          <div className=" flex flex-col md:flex-row items-center mb-8 w-10/12 mx-auto gap-3">
            ...
            <div className="flex flex-col items-start mb-8">
              ...
              <p className="text-lg text-left max-w-md">
                ...
                generated content. You can share it with others or download it
                for yourself.
              </p>
            </div>
          </div>
