        ...
        <div className=" flex flex-col gap-[9px] p-8">
          <div className=" flex flex-col gap-[9px] md:w-2/3 w-full">
            ...
            <p className=" text-lg leading-10">
              Develop customized contracts tailored to unique business needs.
              Incorporate industry-specific clauses and risk management
              strategies. Structure contracts for scalability and compliance
          ...
          <div className=" flex flex-col gap-[9px] md:w-2/3 w-full">
            ...
            <p className=" text-lg leading-10">
              Businesses and individuals with complex, agreements or
              transactions requiring more tailored contractual arrangements
            </p>
          </div>
          <div className=" flex flex-col gap-[9px] md:w-2/3 w-full">
...
export default DraftingAdvance;
