        ...
        <div className=" flex flex-col gap-[9px] p-8">
          <div className=" flex flex-col gap-[9px] md:w-2/3 w-full">
            ...
            <p className=" text-lg leading-10">
              Conduct a detailed contract review and provide suggested edits and
              amendments to protect your interests. Highlight potential
              improvements and alternative wording for stronger clarity and risk
              mitigation. Align contracts with industry best practices.
            </p>
          </div>
          <div className=" flex flex-col gap-[9px] md:w-2/3 w-full">
            <h2 className=" text-3xl font-semibold italic">Ideal For</h2>
            <p className=" text-lg leading-10">
              Individuals and businesses who require detailed insights and
              suggested changes to improve contract terms but do not require
              full drafting.
            </p>
          </div>
          <div className=" flex flex-col gap-[9px] md:w-2/3 w-full">
            ...
            <p className=" text-lg leading-10">
              ...
              marked-up contract via email <br /> or <br /> Book a free
              discovery call to discuss your needs before proceeding with the
              review.
            </p>
          </div>
          <div className=" flex flex-col gap-[9px] md:w-2/3 w-full">
            ...
            <p className=" text-lg leading-7">
              A reviewed contract with comments and recommended modifications
              within 24 – 48 hours.
            </p>
          </div>
        </div>
